 ...
 * 
 * @param <NAMESPACE> The type of the namespace that contains this Class.
 * @param <PACKAGE> The type of the importer of this Class.
 * @param <DEPENDENCY> The type of Dependency of this Class.
 * @param <CONSTRAINT> The type of the Constraint under which this Class is. 
 * @param <OWNED> Type of the ownedElements by this Class.  
 * @param <FEATURE> Type of the Feature of this Class.
 * @param <INDEX> Identifies the type if Index instances that span this Class. 
 * 
 */
public interface GCwmClass<
...
{	
	 ...
	 * <p>
	 * This relationship is separate from the ownership of indexes, to allow modeling of systems where an index is NOT owned by the object it spans. 
	 * In most situations, however, the spanned and owning Class instances will be the same.
	 * </p>
	 * 
	 * </p>
	 * <p>
	 ...
	 * 
	 */
	Boolean removeIndex( GIndex<?, ?, ?, ?> index );
}