 ...
 * 
 */
public interface JDBCPackageUsage
extends
	GPackageUsage<JDBCConnection>
{
...
//====================================================================================================================================================
	 ...
	 * </p>
	 * 
	 * @param jdbcConnection The modelElement that will be affect by a supplier by this Dependency. 
	 *
	 ...
	 * 
	 */	
	Boolean addClient( JDBCConnection jdbcConnection );	
}