 ...
 * 
 * <p>
 * In the meta-model Package is a subclass of Namespace. A Package contains ModelElements such as Packages and Classifiers. A Package may also
 * contain Constraints and Dependencies between ModelElements of the Package.
 * </p>
 * <p>
	...
	, ImportedElement<IMPORTED>
{
	...
	Set<MANAGER> getDataManagers();



	Boolean removeDataManager( GDataManager<?, ?> datatManager );



	<GENERIC_MANAGER extends MANAGER> Set<GENERIC_MANAGER> getGenericManagers( Class<GENERIC_MANAGER> typeOf );



	<GENERIC_MANAGER extends MANAGER> GENERIC_MANAGER getDataManager( Class<GENERIC_MANAGER> typeOf, String simpleName );
}