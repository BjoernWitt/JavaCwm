...
/**
 * Each instance of RowSet owns a collection of Row instances. The inherited association between Namespace (a superclass of Package) and ModelElement 
 ...
 * 
 * @param <COLUMN_SET> The type of the ColumnSet that contains this RowSet.
 * @param <ROW> Type of rows owned by this RowSet. 
 * 
 */
public interface GRowSet<
	...
	, ROW        extends GRow<?, ?, ?>
> extends
	GExtent<MANAGER, COLUMN_SET, Schema, ROW, ROW>
{
