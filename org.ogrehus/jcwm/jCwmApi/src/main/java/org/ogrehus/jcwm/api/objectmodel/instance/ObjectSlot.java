...
/**
 * A slot is a named location in an Object instance that holds the current value of the StructuralFeature associated with the AttributeSlot instance. 
 * <p>
 ...
 * </p>
 * <ul>
 * <li><b>[C-6-5]</b> - If the StructuralFeature describing a ObjectSlot is an AssociationEnd, the Classifier associated with 
 * the Object owning the ObjectSlot must be an Association.</li>
 * <li><b>[C-6-9]</b> - If the ObjectSlot instance is not also a DataSlot, the value reference must be present.</li>
 * </ul>
 * 
 * <p>
