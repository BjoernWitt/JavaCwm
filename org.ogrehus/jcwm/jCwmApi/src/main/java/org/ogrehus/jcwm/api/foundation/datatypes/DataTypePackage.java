 ...
 * The CWM DataTypes meta-model supports definition of meta-model constructs that modelers can use to create the specific data types they need. 
 * Although the CWM Foundation itself does not contain specific data type definitions, a number of data type definitions for widely used environments 
 * are provided as examples of the appropriate usage of CWM Foundation classes for creating data type definitions.
 * </p> 
 * 
 * <p>
 ...
 * 
 */
public abstract class DataTypePackage {


	/**
	 * Creates a new instance of the DataTypePackage.
	 * 
	 * <p>
	 ...
	 * <code>org.ogrehus.jcwm.api.foundation.datatypes.DataTypePackage</code>.
	 * 
	 * @return A new instance of DataTypePackage, determined by the specific 
	 * classPath.
	 * 
	 * @throws ClassNotFoundException If the class can not be found, or if the class does not extends 
	 * <code>org.ogrehus.jcwm.api.foundation.datatypes.DataTypePackage</code> or if the class does not provide a simple public constructor without 
	 * any parameters.
	 * 
	 */
	public static final DataTypePackage create( String classPath )
	throws 
		ClassNotFoundException
	{
		try {
			Object dataType = Class.forName( classPath ).getDeclaredConstructor().newInstance();
			if ( dataType instanceof DataTypePackage ) {
				return (DataTypePackage)dataType;
			}
			throw new ClassNotFoundException( 
				"Invalid Class, it must extend org.ogrehus.jcwm.api.foundation.datatypes.DataTypePackage:" + classPath );
		} catch (InstantiationException e) {
			throw new ClassNotFoundException( "Invalid DataTypePackage class:" + classPath, e );
		} catch (IllegalArgumentException|IllegalAccessException|InvocationTargetException|NoSuchMethodException e) {
			throw new ClassNotFoundException( "Invalid DataTypePackage class (default constructor is missing):" + classPath, e );
		} catch (SecurityException e) {
			throw new ClassNotFoundException( "Invalid DataTypePackage class ([security] unable to find in current class loader):" + classPath, e );	
		}
	}
	 ...
	 * , <code>isOrdered</code>, <code>firstLiteralName</code> or <code>firstLiteralName</code> is <code>null</code>.
	 * 
	 */
	abstract public CwmEnumeration createCwmEnumeration( 
		  String name
	 ...
	 * 
	 */
	abstract public QueryExpression createQueryExpression( String body );	
	 ...
	 * 
	 */
	abstract public <T extends GClassifier<?, ?, ?, ?, ?, ?>> TypeAlias<T> createTypeAlias( 
		  String name
		, Visibility visibility
		, Boolean notInstantiable
		, T type
...
//	 * the Union discriminator would assume this instance <i>memberCase value</i>). Must not be <code>null</code>.
//	 * 
