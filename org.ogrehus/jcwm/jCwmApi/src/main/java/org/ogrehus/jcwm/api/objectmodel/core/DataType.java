 ...
 * 
 * @see org.ogrehus.jcwm.api.objectmodel.core.util.generic.GDataType
 *
 */
public interface DataType
extends
	  GDataType<TypeSystem, Attribute>
{
...
//====================================================================================================================================================
	...
	/**
	 * Appends a Feature that will be owned by this DataType.
	 * 
	 * @param feature that will be owned by this DataType. 
	 *
	 * @return <code>true</code> if this Collection changed as a result of the call, <code>false</code> otherwise.
	 * 
	 */	
	Boolean addFeature( Attribute feature );
}