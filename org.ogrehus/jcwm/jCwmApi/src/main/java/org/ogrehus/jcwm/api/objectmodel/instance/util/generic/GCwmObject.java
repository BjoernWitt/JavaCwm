 ...
 * </p>
 * <p>
 * An Object instance's slots may contain either DataValue instances or other Object instances. Owned Object instances occur as side-effects of either
 ...
 * 
 * @param <EXTENT> The type of the Namespace that contains this CwmObject.
 * @param <PACKAGE> The type of the importer of this CwmObject.
 * @param <CLASS> The type of this CwmObject. 
 * @param <SLOT> The slot for this CwmObject.
 * 
 */
public interface GCwmObject<
	  EXTENT  extends GExtent<?, ?, ?, ?, ?>
	, PACKAGE extends GCwmPackage<?, ?, ?, ?, ?, ?, ?>
	, CLASS   extends GCwmClass<?, ?, ?, ?, ?, ?, ?>
	, SLOT    extends GSlot<?, ?, ?, ?, ?>
> extends
	GInstance<EXTENT, PACKAGE, CLASS, SLOT>
{


	/**
	 * The set of Slot instances owned by the CwmObject.
	 * <p>
	 ...
	 * </ul>
	 * 
	 *  @return A Set of Slot instances owned by the CwmObject.
	 * 
	 */
	Set<SLOT> getSlots();
	 ...
	 * </ul>
	 * 
	 * @see #getSlot() For more descriptions on the property <code>slot</code>.
	 * 
	 * @param slot New value (set of Slot instances) owned by this CwmObject.
	 * 
	 * @return <code>true</code> if this Collection changed as a result of the call, <code>false</code> otherwise.
	 * 
	 */
	Boolean removeSlot( GSlot<?, ?, ?, ?, ?> slot );
	 ...
	 * </ul>
	 * 
	 * @return The designated Extent of this CwmObject, or <code>null</code>, if none was designated.
	 * 
	 */
	EXTENT getNamespace();
	 ...
	 *     contents = self.slot->union(self.slot.instance) 
	 * </pre>
	 * This OCL cannot be found in the CWM Specification.
	 * 
	 * @return All Objects and DataValues held by this Object.
	 * 
	 */
	Set<GInstance<?, ?, ?, ?>> getContents();
}