 ...
 * 
 */
public interface SQLStructuredAttribute
extends
	GColumn<Constraint, SQLStructuredType>
{
...
//====================================================================================================================================================
	 ...
	 * 
	 */
	Boolean addConstraint( Constraint checkConstraint );
...
//====================================================================================================================================================
	 ...
	 * </ul>
	 * 
	 * @param queryColumnSet The ColumnSet declaring this Column.
	 *
	 * @return The old value of owner if one is available, <code>null</code> otherwise.
	 * 
	 */
	SQLStructuredType setOwner( SQLStructuredType sqlStructuredType );
}