 ...
 * 
 */
public class FunViewColumn
extends
	GFunColumn<Constraint, View>
implements
	ViewColumn
{
	 ...
	 * 
	 */
	protected <TYPE extends SQLDataType<?, ?>> FunViewColumn( String name, TYPE type ) {
...
//====================================================================================================================================================
	...
	public String toString() {
		StringBuffer out = new StringBuffer( "[FunTableColumn" );
		out.append( " |\nextends: " );
...
//====================================================================================================================================================
	 ...
	 * <li><i>inverse</i>		: Table::feature</li>
	 * </ul>
	 * 
	 * @param view The ColumnSet declaring this Column.
	 *
	 * @return The old value of owner if one is available, <code>null</code> otherwise.
	 * 
	 */
	public View setOwner( View view ) {
		return super.setOwnerGeneric( view );
	}
}