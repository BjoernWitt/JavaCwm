 ...
 * 
 * <p>
 * In CWM, the set of data types an Any attribute or parameter may assume includes the data types and enumerations described in this chapter plus any
 * available instances of the Classifier class.
 * </p>
 * 
 * <p>
	...
	CwmAny
{
	...
	/**
	 * Crates a new instance of CwmAny by initial predefined parameters.
	 * 
	 * <p>
	 ...
	 * </ul>
	 * 
	 * @return A new instance of CwmAny by initial predefined parameters.
	 * 
	 */
	public FunCwmAny() {
		super( "Any", Visibility._public, Boolean.TRUE );
	}
