 ...
 * types have default values. These default values only apply for mandatory attributes or parameters of the relevant data type where an explicit value
 * is not supplied.
 * </p>
 * <p>
 * <b>Constraints:</b><br>
 ...
 * 
 * @param <FEATURE> Type of the Feature of this GFunDataType. 
 *
 */
public abstract class GFunDataType<
	  NAMESPACE extends GCwmPackage<?,?,?,?,?,?,?>
	, FEATURE   extends GFeature<?, ?, ?, ?, ?>
> extends
	GFunClassifier<NAMESPACE, TypeSystem, Dependency, Constraint, GModelElement<?, ?, ?, ?>, FEATURE> 
implements
	GDataType<NAMESPACE, FEATURE>  
{
	 ...
	 * 
	 */
	protected GFunDataType( String name, Visibility visibility, Boolean notInstantiable	) {
		super( name, visibility, notInstantiable );
		this.ownedElements = Collections.emptySet(); // Avoids NullPointers by super methods.  
	}



	public Collection<GModelElement<?, ?, ?, ?>> getOwnedElement() {
		return Collections.emptySet(); // empty Set, cause dataType can't own any ModelElement constraint [C_3_2]
	}
...
//====================================================================================================================================================
	...
	public String toString() {
		StringBuffer out = new StringBuffer( "[GFunDataType" );
		out.append( " |\nextends: " );
