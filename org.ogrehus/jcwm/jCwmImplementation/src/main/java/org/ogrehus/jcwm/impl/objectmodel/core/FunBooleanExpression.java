...
/**
 * In the meta-model BooleanExpression defines a statement that will evaluate to an instance of Boolean when it is 
 * evaluated.
 * <p>
 ...
 *
 */
public class FunBooleanExpression
extends
	FunExpression
implements
	BooleanExpression 
{
	...
	/**
	 * Creates a new instance of BooleanExpression by specific parameters.
	 * 
	 ...
	 */
	public FunBooleanExpression( String body ) {
		super( body );
	}
}