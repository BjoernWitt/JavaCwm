 ...
 * 
 */
public class FunTableColumn
extends
	GFunColumn<CheckConstraint, Table>
implements
	TableColumn
{
	 ...
	 * 
	 */
	protected <TYPE extends SQLDataType<?, ?>> FunTableColumn( String name, TYPE type ) {
...
//====================================================================================================================================================
	 ...
	 * 
	 */
	public Table setOwner( Table table ) {
		return super.setOwnerGeneric( table );
	}
}