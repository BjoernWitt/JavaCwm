...
import org.ogrehus.jcwm.api.resource.relational.util.types.JdbcLongVarChar;
import org.ogrehus.jcwm.impl.resource.relational.FunSQLSimpleType;

public class FunJdbcLongVarChar 
extends 
	FunSQLSimpleType
implements
	JdbcLongVarChar
{
	...
	public FunJdbcLongVarChar( Integer numericPrecision ) {
		this( null, numericPrecision );
	}



	public FunJdbcLongVarChar( String name, Integer numericPrecision ) {
		super( name==null?"LONGVARCHAR":name, Visibility._public, Boolean.TRUE );
		this.setNumericPrecision( numericPrecision );
		this.typeNumber = Types.LONGVARCHAR;
	}
