	...
	CwmFloat
{
	...
	/**
	 * Crates a new instance of FunCwmFloat by initial predefined parameters.
	 * 
	 * <p>
	 ...
	 */
	public FunCwmFloat() {
		super( "Float", Visibility._public, Boolean.TRUE );
	}



	/**
	 * The default for data type Float is <code>"0.0"</code>.
	 * 
