...
import org.ogrehus.jcwm.api.foundation.softwaredeployment.PackageUsage;
...
import org.ogrehus.jcwm.impl.objectmodel.core.util.generic.GFunDependency;
	...
	PackageUsage
{
	 ...
	 * 
	 */
	protected GFunPackageUsage( String name, Visibility visibility, CLIENT client, ModelElement supplier ) {
...
//====================================================================================================================================================
// PackageUsage capabilities
//====================================================================================================================================================



	public Set<String> getPackageAlias() {
		return this.packageAlias;
	}



	public Boolean addPackageAlias( String packageAlias ) {
		return this.packageAlias.add( packageAlias );
	}



	public Boolean removePackageAlias(String packageAlias) {
		return this.packageAlias.remove( packageAlias );
	}
...
//====================================================================================================================================================
	 ...
	 * 
	 */
	protected Set<String> packageAlias = null;
}