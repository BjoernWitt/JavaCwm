...
//====================================================================================================================================================
	...
	public Boolean addClient( GModelElement<?, ?, ?, ?> client ) {
		if ( this.clients.add( client ) ) {
			invokeByReflection( client, "addDependency", this ); // bi-directional reference
